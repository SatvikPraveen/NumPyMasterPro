...
def generate_random_integers(low: int, high: int, size: int, seed: int | None = None) -> np.ndarray:
...
def generate_random_floats(size: int, seed: int | None = None) -> np.ndarray:
...
def generate_normal_distribution(size: int, seed: int | None = None) -> np.ndarray:
